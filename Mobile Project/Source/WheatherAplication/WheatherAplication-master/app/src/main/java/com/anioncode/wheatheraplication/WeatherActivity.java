...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view_temp.setText("");
        view_hum=findViewById(R.id.hum);
        view_hum.setText("");
        view_press=findViewById(R.id.press);
        view_press.setText("");
    ...
    private void api_key(final String City) {
        ...
        Request request=new Request.Builder()
                .url("https://api.openweathermap.org/data/2.5/weather?q="+City+"&appid=a526223f9861461bda98b591c8fffaf7&units=metric")
                .get()
                .build();
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                    ...
                    try {
                        ...
                        String press=Math.round(Pressure)+" Hpa";
                        String hum=Humidity +" %";

                        setText(view_temp,temps);
                        setText(view_hum,hum);
                        setText(view_press,press);
